(function() {
    ...
    function showDisconnectedAlert() {
        ...
        Toast.fire({
            icon: 'error',
            title: 'Disconnected from a server'
        })
    }
 ...
 /* Freeze key ( F ) */
            if (event.keyCode == 70) {
                ...
                newcanvas.trigger($.Event("mousemove", {clientX: X, clientY: Y}));
            }
  ...
  function colorToBytes(color) {
    ...
    var eatSound = new Sound("https://www.youtube.com/watch?v=MBmb5_TTT-w", 0.5, 10);
    ...
    function drawLeaderboard() {
        ...
        ctx.fillText("Flare.io", 100 - ctx.measureText("Flare.io").width / 2, 40);
    ...
    function drawGame() {
        ...
        mainCtx.fillStyle = settings.darkTheme ? "#000" : "#fff";
        ...
        if (!isNaN(stats.latency)) gameStatsText += " " + stats.latency + " ping";
    ...
    function init() {
        ...
        window.setserver("circular-notch-cauliflower.glitch.me");
        window.requestAnimationFrame(drawGame);
